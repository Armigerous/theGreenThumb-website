...
// Reason: Mali font is the brand's title font for headings and emphasis per brand guide
const mali = Mali({
  subsets: ["latin"],
...
// Reason: Nunito font is the brand's body font for readable paragraph text per brand guide
const nunito = Nunito({
  subsets: ["latin"],
  weight: ["400", "500", "600", "700"],
