...
const FilterSectionAccordion = dynamic(
	() =>
		import("./FilterSectionAccordion").then((mod) => ({
			default: mod.FilterSectionAccordion,
		})),
	{
		ssr: false,
	}
...
const PremadeFilters = dynamic(
	() =>
		import("./PremadeFilters").then((mod) => ({ default: mod.PremadeFilters })),
	{
		ssr: false,
	}
);
