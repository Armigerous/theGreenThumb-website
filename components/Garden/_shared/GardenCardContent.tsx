...
export const GardenCardContent: React.FC<GardenCardContentProps> = ({
  ...
  // Reason: Calculate healthy plants count based on statistics type
  const healthyPlants = isTaskBased
    ? statistics.totalPlants -
      (statistics as { plantsNeedingCare: number }).plantsNeedingCare
    : (statistics as { healthyPlants: number }).healthyPlants;

  // Reason: Calculate plants needing care count based on statistics type
  const plantsNeedingCare = isTaskBased
    ? (statistics as { plantsNeedingCare: number }).plantsNeedingCare
    : (statistics as { plantsNeedingCare: number }).plantsNeedingCare;
