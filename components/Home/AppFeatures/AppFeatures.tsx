			...
			<MaxWidthWrapper className="flex flex-col items-center text-left flex-grow justify-center">
				<motion.div className="mb-16 sm:mb-28" variants={variants}>
					<div className="flex flex-col sm:flex-row items-center gap-8 sm:gap-12">
						...
						/>
						<h2 className="text-4xl sm:text-8xl font-thin text-cream-800">
					...
					<div className="flex flex-col sm:flex-row items-center gap-5 mt-5 text-cream-800">
						...
						<div style={{ zIndex: 10 }}>
							<Link href="/contact" className="block w-fit">
								<Button className="w-48 sm:w-72 h-16 sm:h-20 rounded-xl text-lg sm:text-2xl font-title-bold text-cream-50 bg-primary">
									ASK US DIRECTLY
								</Button>
							</Link>
						</div>
