...
const Text = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="text-3xl sm:text-4xl md:text-6xl mb-4 font-thin leading-tight sm:leading-normal md:leading-relaxed lg:leading-normal"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
      >
      ...
      <motion.p
        className="mb-4 text-sm sm:text-base md:text-xl max-w-full leading-relaxed"
        variants={fadeInUp}
      >
