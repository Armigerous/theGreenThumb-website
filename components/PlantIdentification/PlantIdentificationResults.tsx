  ...
  return (
    ...
    >
      ...
      <CardHeader className="px-5 py-4 flex-shrink-0">
        ...
        >
          <CardTitle className="text-lg font-semibold line-clamp-1 group-hover/header:underline leading-tight">
            {displayName}
          </CardTitle>
      ...
      <CardFooter className="mt-auto px-5 py-4 flex-shrink-0">
        <Link
          ...
          className="w-full"
        >
          <p className="text-sm text-primary group-hover/card:underline font-medium">
            Learn more →
          </p>
        </Link>
      </CardFooter>
