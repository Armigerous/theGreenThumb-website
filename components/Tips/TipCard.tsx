			...
			>
				...
				<div className={"flex-1 flex flex-col"}>
					<CardHeader>
						{/* Title */}
						<Link href={`/tip/${slug?.current}`}>
							<CardTitle className="text-lg font-title-bold line-clamp-1 hover:underline">
								{title}
							</CardTitle>
						</Link>
						<CardDescription>
					...
					<CardFooter>
						<Link href={`/tip/${slug?.current}`}>
							<span className="text-sm text-primary font-paragraph-semibold group-hover:underline flex items-center">
