    ...
    <Card>
      <CardContent className="pt-6">
        <div className="space-y-8">
          <div>
            <h3 className="text-lg font-medium mb-4">Flower-Related</h3>

            <div className="space-y-4 mb-6">
              <div className="space-y-2">
                <Label className="text-lg font-semibold">Flower Color</Label>
            ...
            <div className="space-y-4 mb-6">
              <div className="space-y-2">
                <Label className="text-lg font-semibold">Bloom Time</Label>
                <p className="text-base text-primary font-medium">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label className="text-lg font-semibold">Flower Value</Label>
                <p className="text-base text-primary font-medium">
          ...
          <div>
            <h3 className="text-lg font-medium mb-4">Leaf-Related</h3>

            <div className="space-y-4">
              <div className="space-y-4 mb-6">
                <div className="space-y-2">
                  <Label className="text-lg font-semibold">Leaf Feel</Label>
                  <p className="text-base text-primary font-medium">
            ...
            <div className="space-y-4 mb-6">
              <div className="space-y-2">
                <Label className="text-lg font-semibold">Leaf Color</Label>
                <p className="text-base text-primary font-medium">
            ...
            <div className="space-y-4 mb-6">
              <div className="space-y-2">
                <Label className="text-lg font-semibold">Leaf Value</Label>
                <p className="text-base text-primary font-medium">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label className="text-lg font-semibold">Fall Color</Label>
                <p className="text-base text-primary font-medium">
