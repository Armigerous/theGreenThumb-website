					...
					<div className="space-y-4">
						...
						<div className="space-y-4 border rounded-md p-4 bg-muted/20">
							<div className="space-y-3">
								<p className="text-sm font-paragraph-semibold">Soil Texture</p>
							...
							<div className="space-y-3">
								<p className="text-sm font-paragraph-semibold">Soil pH</p>
								<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
							...
							<div className="space-y-3">
								<p className="text-sm font-paragraph-semibold">Soil Drainage</p>
								<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
