        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <div className="space-y-2">
              <Label className="text-lg font-semibold">Growth Rate</Label>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label className="text-lg font-semibold">Maintenance Level</Label>
              <p className="text-base text-primary font-medium">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label className="text-lg font-semibold">Plant Form</Label>
              <p className="text-base text-primary font-medium">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label className="text-lg font-semibold">Plant Type</Label>
              <p className="text-base text-primary font-medium">
