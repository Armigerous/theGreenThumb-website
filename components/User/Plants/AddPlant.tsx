      ...
      try {
        ...
        const endpoint =
          searchQuery && searchQuery.length >= 2
            ? `/api/plants/search?query=${encodeURIComponent(searchQuery)}&nameType=${useCommonNames ? "common" : "scientific"}`
            : `/api/plants/popular?nameType=${useCommonNames ? "common" : "scientific"}&limit=7`;
                        ...
                        <div className="space-y-6 flex-1">
                          <div className="flex items-center space-x-2 mb-4">
                            <Switch
                              ...
                              onValueChange={setUseCommonNames}
                              size="lg"
