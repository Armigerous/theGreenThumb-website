 ...
 */
const siteMetaData = {
  title: "The GreenThumb helping North Carolina gardeners", // Site title
  author: "Eren Kahveci", // Author name
  headerTitle: "The GreenThumb Official Website", // Header title
  ...
  siteLogo: "/logo.png", // Path to the site logo (default)
  siteLogoTransparent: "/logo-transparent.png", // Path to the transparent logo variant
